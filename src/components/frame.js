...
const Frame = ({ title, children }) => {
  return (
    <div
      className={`flex flex-col divide-y-4 divide-stone-800 border-4 border-stone-800 rounded-2xl shadow-window shadow-stone-800 bg-yellow-50 bg-noise bg-repeat`}
    >
